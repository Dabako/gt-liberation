...
heavy_vehicles = [
	...
	["rhs_sprut_vdv", 300,250,165],										// Sprut
...
air_vehicles = [
    ["rhs_pchela1t_vvsc",25,0,25],                                      // AR-2 Tayran
    ["O_UAV_06_F",80,0,30],                                             // AL-6 Jinaah (Cargo)
    ["RHS_Mi8mt_Cargo_vvsc",200,0,100],                                 // MI-8MT (Cargo)
...
buildings = [
	...
	["BloodSpray_01_New_F",0,0,0],
	["Land_BloodBag_F",0,0,0],
